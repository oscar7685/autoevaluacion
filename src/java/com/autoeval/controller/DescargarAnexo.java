...
public class DescargarAnexo extends HttpServlet {
    ...
    private final Logger LOGGER = Logger.getLogger(DescargarAnexo.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String ruta = request.getSession().getServletContext().getRealPath("/WEB-INF/classes/com/autoeval/files/anexos");
            ruta += "\\" + file;
